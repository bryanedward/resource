...
function newToken(_x, _x2) {
  return _newToken.apply(this, arguments);
}

function _newToken() {
  _newToken = _asyncToGenerator(
  /*#__PURE__*/
...
function _createPublication() {
  ...
  regeneratorRuntime.mark(function _callee2(req, res) {
    var _req$body, namePublication, description, Userid, urlimg;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _req$body = req.body, namePublication = _req$body.namePublication, description = _req$body.description, Userid = _req$body.Userid, urlimg = _req$body.urlimg;
            _context2.next = 3;
...
function getPublications(_x5, _x6) {
...
function getOnePublication(_x7, _x8) {
...
function updatePublication(_x9, _x10) {
...
function deletePublication(_x11, _x12) {
...
function getPublicationByUserid(_x13, _x14) {
...
function getUserDouble(_x17, _x18) {
